...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/knx)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/knx
```

A live public deployment of this template is available at [https://knx.templates.workers.dev](https://knx.templates.workers.dev)
